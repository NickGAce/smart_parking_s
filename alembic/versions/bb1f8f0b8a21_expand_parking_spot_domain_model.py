...
spot_type_enum = sa.Enum('regular', 'guest', 'disabled', 'ev', 'reserved', 'vip', name='spottype')
vehicle_type_enum = sa.Enum('car', 'bike', 'truck', name='vehicletype')
size_category_enum = sa.Enum('small', 'medium', 'large', name='sizecategory')
zone_type_enum = sa.Enum('general', 'premium', 'service', 'restricted', name='zonetype')
access_level_enum = sa.Enum('public', 'employees', 'permit_only', 'vip_only', name='accesslevel')
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('zone_type', zone_type_enum, nullable=False, server_default='general'),
        sa.Column('access_level', access_level_enum, nullable=False, server_default='public'),
    ...
    op.add_column('parking_spots', sa.Column('spot_type', spot_type_enum, nullable=False, server_default='regular'))
    op.add_column('parking_spots', sa.Column('vehicle_type', vehicle_type_enum, nullable=False, server_default='car'))
    ...
    op.add_column('parking_spots', sa.Column('size_category', size_category_enum, nullable=False, server_default='medium'))
